...
"<form action='/wifi'    method='get'><button>Tarama Yap</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>Configure WiFi (No scan)</button></form><br/>\n", // MENU_WIFINOSCAN
"<form action='/info'    method='get'><button>Bilgilendirme</button></form><br/>\n", // MENU_INFO
...
const char HTTP_HELP[]             PROGMEM =
 "<br/><h3>Bilgilendirme</h3><hr>"
 "<table class='table'>"
 "<thead><tr><th>Adım</th><th>Açıklama</th></tr></thead><tbody>"
 "<tr><td><a href='İlk Kurulum'>İlk Kurulum</a></td>"
 "<td>Modul, Tarama menüsünden kaydettiğiniz ağa bağlanabilirse, bu ağı kaydederek her açılışta bu ağa bağlanmaya çalışacaktır.</td></tr>"
  "<tr><td><a href='Kurulum Sonrası'>Kurulum Sonrası</a></td>"
 "<td>Eğer modül kaydettiğiniz ağı çevrede bulamaz/bağlanamazsa kendisi TeleportWiFi ağı açacaaktır.</td></tr>"
   "<tr><td><a href='Son Kaydetiğiniz WiFi'>Son Kaydetiğiniz WiFi</a></td>"
 "<td>Modülün bağlanması için son ayarladığınız ağı ve bilgilerini, yukardaki WiFi menüsü içerisinde SSID bölümünde görebilirsiniz</td></tr>"
 "</table>"
 "<p/>Github <a href='https://github.com/EngHuseyinG?tab=repositories'>https://github.com/EngHuseyinG?tab=repositories</a>."
 "<p/>Linked.in <a href='https://www.linkedin.com/in/hüseyin-gürel-183a4a85/'>https://www.linkedin.com/in/hüseyin-gürel-183a4a85/</a>.";
#else
const char HTTP_HELP[]             PROGMEM = "";
#endif
...
#ifdef ESP32
	const char HTTP_INFO_esphead[]    PROGMEM = "<h3>Teleport WiFi</h3><hr><dl>";
	const char HTTP_INFO_chiprev[]    PROGMEM = "<dt>Chip rev</dt><dd>{1}</dd>";
  	const char HTTP_INFO_lastreset[]  PROGMEM = "<dt>Last reset reason</dt><dd>CPU0: {1}<br/>CPU1: {2}</dd>";
  	const char HTTP_INFO_aphost[]     PROGMEM = "<dt>Access point hostname</dt><dd>Teleport WiFi</dd>";
...
const char HTTP_INFO_host[]       PROGMEM = "<dt>Hostname</dt><dd>ESP32U</dd>";
const char HTTP_INFO_stamac[]     PROGMEM = "<dt>Station MAC</dt><dd>{1}</dd>";
const char HTTP_INFO_conx[]       PROGMEM = "<dt>Connected</dt><dd>{1}</dd>";
const char HTTP_INFO_autoconx[]   PROGMEM = "<dt>Autoconnect</dt><dd>{1}</dd>";

const char HTTP_INFO_aboutver[]     PROGMEM = "<dt>Teleportal WiFi Manager</dt><dd>v1.0</dd>";
const char HTTP_INFO_aboutarduino[] PROGMEM = "<dt>Platform</dt><dd>Teleportal 4.0</dd>";
const char HTTP_INFO_aboutsdk[]     PROGMEM = "<dt>ESP-SDK/IDF</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutdate[]    PROGMEM = "<dt>Build date</dt><dd>02.11.2024</dd>";

const char S_brand[]              PROGMEM = "Modül WiFi Kurulumu";
